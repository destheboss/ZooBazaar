...
namespace Desktop.Forms
{
    public partial class AnimalCRUD : Form
    {
        ...
        private void AnimalCRUD_Load_1(object sender, EventArgs e)
        {
            DisplayAllAnimals();
        ...
        private void ShowAnimals_btn_Click(object sender, EventArgs e)
        {
            DisplayAllAnimals();
        }

        private void DeleteAnimal_btn_Click(object sender, EventArgs e)
        {
            if (viewAllAnimals_dgv.SelectedRows.Count > 0)
            {
                DataGridViewRow selectedRow = viewAllAnimals_dgv.SelectedRows[0];
        ...
        private void Add_animal_btn_Click(object sender, EventArgs e)
        {
            try
            {
                string animalName = name_tb.Text;
                ...
                Animal animal = new Animal(0, animalName, dateOfBirth, animalWeight, animalType, animalLocation);
        ...
        private void Edit_Animal_btn_Click(object sender, EventArgs e)
        {
            if (viewAllAnimals_dgv.SelectedRows.Count > 0)
            {
                DataGridViewRow selectedRow = viewAllAnimals_dgv.SelectedRows[0];
        ...
        private void searchButton_Click(object sender, EventArgs e)
        {
            ...
            {
                List<Animal> searchResults = animalManager.SearchAnimalsByName(searchTerm);
                ...
                if (searchResults.Count > 0)
                {
                    ...
                    // Add the code to populate the DataGridView with searchResults
                    // Similar to the DisplayAllAnimals() method but for searchResults
                    viewAllAnimals_dgv.Columns.Add("Id", "ID");
                    viewAllAnimals_dgv.Columns.Add("Name", "Name");
                    viewAllAnimals_dgv.Columns.Add("Type", "Type");
                    viewAllAnimals_dgv.Columns.Add("Weight", "Weight");
                ...
                {
                    MessageBox.Show("No matching animals found.");
                }
            }
            else
            {
        ...
        private void ShowNotesButton_Click_Click(object sender, EventArgs e)
        {
            if (viewAllAnimals_dgv.SelectedRows.Count > 0)
            {
                DataGridViewRow selectedRow = viewAllAnimals_dgv.SelectedRows[0];
                ...
                List<AnimalNotes> notes = animalManager.GetNotesByAnimalId(animalId);

                if (notes.Count > 0)
                {
                    StringBuilder notesText = new StringBuilder();
                    foreach (AnimalNotes note in notes)
                    {
                        notesText.AppendLine($"Note: {note.Note}, Created At: {note.CreatedAt}");
                    }

                    MessageBox.Show($"Notes for Animal ID {animalId}:\n\n{notesText.ToString()}", "Animal Notes");
                }
                else
                {
                    MessageBox.Show("No notes found for the selected animal.");
                }
            }
            else
            {
