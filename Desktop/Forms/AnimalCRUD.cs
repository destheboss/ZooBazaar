...
namespace ZooBazaar
{
    public partial class Animal_CRUD : Form
    {
        ...
        private readonly Animaltypemanager animalTypeManager = new Animaltypemanager();
        ...
        public Animal_CRUD(Animal animal)
        {
            InitializeComponent();
            Animal = animal;
        ...
        private void Animal_CRUD_Load_1(object sender, EventArgs e)
        {
            DisplayAliveAnimal();
        ...
        private void ResetAnimalField()
        {
            ...
            dateTime_Pick.Value = DateTime.Now;
        ...
        private void editAnimal_btn_Click(object sender, EventArgs e)
        {
            if (viewAllAnimals_dgv.SelectedRows.Count > 0)
            {
                ...
                dateTime_Pick.Value = Convert.ToDateTime(selectedRow.Cells["DateOfBirth"].Value);
        ...
        private void saveAnimal_btn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var animal = new Animal(animalId, name_tb.Text, dateTime_Pick.Value, Convert.ToDecimal(weight_tb.Text),
        ...
        private void displayAllAnimals_btn_Click_2(object sender, EventArgs e)
        {
            DisplayAllAnimals();
        }
